...
public class StringHelper {
    ...
    public static List<ITextComponent> getShiftInfoGui()
    {
        ...
        list.add(new TranslationTextComponent("tooltip." + CuboidMod.MOD_ID + ".gui_close"));
        IFormattableTextComponent tooltip1 = new TranslationTextComponent("tooltip." + CuboidMod.MOD_ID + ".gui_hold_shift");
        IFormattableTextComponent shift = new StringTextComponent("[Shift]");
        IFormattableTextComponent tooltip2 = new TranslationTextComponent("tooltip." + CuboidMod.MOD_ID + ".gui_shift_more_options");
    ...
    {
        IFormattableTextComponent tooltip1 = new TranslationTextComponent("tooltip." + CuboidMod.MOD_ID + ".hold");
        IFormattableTextComponent shift = new StringTextComponent("[Shift]");
        IFormattableTextComponent tooltip2 = new TranslationTextComponent("tooltip." + CuboidMod.MOD_ID + ".for_details");
        tooltip1.withStyle(TextFormatting.GRAY);
        shift.withStyle(TextFormatting.GOLD, TextFormatting.ITALIC);
        tooltip2.withStyle(TextFormatting.GRAY);
