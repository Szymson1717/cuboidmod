...
@OnlyIn(Dist.CLIENT)
public class QuantumTransmutationChamberScreen extends ContainerScreen<QuantumTransmutationChamberContainer> {
    ...
    public QuantumTransmutationChamberScreen(QuantumTransmutationChamberContainer container, PlayerInventory inv, ITextComponent name) {
