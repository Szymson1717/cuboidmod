...
public class CobblestoneQuantumSingularityItem extends QuantumSingularityItemBase {
    public CobblestoneQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "cobblestone")));
    }
}
