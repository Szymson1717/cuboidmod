...
public class GoldQuantumSingularityItem extends QuantumSingularityItemBase {
    public GoldQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "gold")));
    }
}
