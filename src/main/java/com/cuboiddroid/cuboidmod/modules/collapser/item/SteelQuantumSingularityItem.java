...
public class SteelQuantumSingularityItem extends QuantumSingularityItemBase {
    public SteelQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "steel")));
    }
}
