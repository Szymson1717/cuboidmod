...
public class RedstoneQuantumSingularityItem extends QuantumSingularityItemBase {
    public RedstoneQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "redstone")));
    }
}
