...
public class DirtQuantumSingularityItem extends QuantumSingularityItemBase {
    public DirtQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "dirt")));
    }
}
