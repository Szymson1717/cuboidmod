...
public class IronQuantumSingularityItem extends QuantumSingularityItemBase {
    public IronQuantumSingularityItem() {
        super(new Properties(),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "iron")));
    }
}
