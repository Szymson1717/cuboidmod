...
public class SilverQuantumSingularityItem extends QuantumSingularityItemBase {
    public SilverQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "silver")));
    }
}
