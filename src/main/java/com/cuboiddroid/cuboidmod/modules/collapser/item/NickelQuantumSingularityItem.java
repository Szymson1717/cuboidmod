...
public class NickelQuantumSingularityItem extends QuantumSingularityItemBase {
    public NickelQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "nickel")));
    }
}
