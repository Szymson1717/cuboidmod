...
public class WikidiumQuantumSingularityItem extends QuantumSingularityItemBase {
    public WikidiumQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "wikidium")));
    }
}
