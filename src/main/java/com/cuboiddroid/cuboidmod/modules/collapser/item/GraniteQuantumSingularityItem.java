...
public class GraniteQuantumSingularityItem extends QuantumSingularityItemBase {
    public GraniteQuantumSingularityItem() {
        super(new Properties(),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "granite")));
    }
}
