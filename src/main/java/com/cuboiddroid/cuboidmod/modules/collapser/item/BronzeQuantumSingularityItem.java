...
public class BronzeQuantumSingularityItem extends QuantumSingularityItemBase {
    public BronzeQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "bronze")));
    }
}
