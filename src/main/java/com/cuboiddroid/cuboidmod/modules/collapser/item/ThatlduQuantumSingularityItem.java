...
public class ThatlduQuantumSingularityItem extends QuantumSingularityItemBase {
    public ThatlduQuantumSingularityItem() {
        super(new Properties().tab(CuboidMod.CUBOIDMOD_ITEM_GROUP),
                QuantumSingularityRegistry.getInstance()
                        .getSingularityById(new ResourceLocation(CuboidMod.MOD_ID, "thatldu")));
    }
}
