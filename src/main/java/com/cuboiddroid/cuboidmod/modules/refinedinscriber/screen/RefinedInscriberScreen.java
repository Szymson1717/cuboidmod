...
@OnlyIn(Dist.CLIENT)
public class RefinedInscriberScreen extends ContainerScreen<RefinedInscriberContainer> {
    ...
    public RefinedInscriberScreen(RefinedInscriberContainer container, PlayerInventory inv, ITextComponent name) {
