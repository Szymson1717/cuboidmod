...
public class ThatlduFurnaceContainer extends CuboidFurnaceContainerBase {
    ...
    public ThatlduFurnaceContainer(int windowId, World level, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.THATLDU_FURNACE.get(), windowId, level, pos, playerInventory, player);
    }

    public ThatlduFurnaceContainer(int windowId, World level, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player, IIntArray fields) {
        super(ModContainers.THATLDU_FURNACE.get(), windowId, level, pos, playerInventory, player, fields);
    }

    @Override
    public boolean stillValid(PlayerEntity player) {
        return isWithinUsableDistance(IWorldPosCallable.create(te.getLevel(), te.getBlockPos()), playerEntity, ModBlocks.THATLDU_FURNACE.get());
    }
}