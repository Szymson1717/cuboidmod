...
public class EumusFurnaceContainer extends CuboidFurnaceContainerBase {
    ...
    public EumusFurnaceContainer(int windowId, World level, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.EUMUS_FURNACE.get(), windowId, level, pos, playerInventory, player);
    }

    public EumusFurnaceContainer(int windowId, World level, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player, IIntArray fields) {
        super(ModContainers.EUMUS_FURNACE.get(), windowId, level, pos, playerInventory, player, fields);
    }

    @Override
    public boolean stillValid(PlayerEntity player) {
        return isWithinUsableDistance(IWorldPosCallable.create(te.getLevel(), te.getBlockPos()), playerEntity, ModBlocks.EUMUS_FURNACE.get());
    }
}