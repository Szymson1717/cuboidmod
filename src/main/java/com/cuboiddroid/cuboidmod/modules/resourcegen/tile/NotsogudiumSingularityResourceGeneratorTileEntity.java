...
public class NotsogudiumSingularityResourceGeneratorTileEntity extends SingularityResourceGeneratorTileEntityBase {
    public NotsogudiumSingularityResourceGeneratorTileEntity() {
        this(BlockPos.ZERO, ModBlocks.NOTSOGUDIUM_SINGULARITY_RESOURCE_GENERATOR.get().defaultBlockState());
    }
    ...
    public Component getDisplayName() {
        return Component.translatable(CuboidMod.MOD_ID + ".container.notsogudium_singularity_resource_generator");
    }
